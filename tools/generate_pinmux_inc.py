...
def emit_series_macros(
    ...
    lines.append("#if !defined(__SAMD51__) && !defined(__SAME51__) && !defined(__SAME53__) && !defined(__SAME54__)")
    ...
    lines.append("#endif // !__SAMD51__ / __SAME51__ && !__SAME53__ / __SAME54__")
    lines.append("#if defined(__SAMD51__) || defined(__SAME51__)")
    ...
    lines.append("#endif // __SAMD51__ / __SAME51__")
    lines.append("#if defined(__SAME53__) || defined(__SAME54__)")
    ...
    lines.append("#endif // __SAME53__ / __SAME54__")
    lines.append("")
    return lines
