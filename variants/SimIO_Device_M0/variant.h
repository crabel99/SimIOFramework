...
#ifndef _VARIANT_SIMIO_DEVICE_M0_
#define _VARIANT_SIMIO_DEVICE_M0_
...
// Serial
#define PIN_SERIAL_UART_TX (16ul)
#define PIN_SERIAL_UART_RX (17ul)
#define PIN_SERIAL_TX PIN_SERIAL_UART_TX
#define PIN_SERIAL_RX PIN_SERIAL_UART_RX
#define PERIPH_SERIAL_UART sercom3
#define PAD_SERIAL_UART_TX UART_TX_PAD_0
#define PAD_SERIAL_UART_RX SERCOM_RX_PAD_1
#define PAD_SERIAL_TX PAD_SERIAL_UART_TX
#define PAD_SERIAL_RX PAD_SERIAL_UART_RX
...
#define SERIAL_PORT_HARDWARE SerialUART
#define SERIAL_PORT_HARDWARE_OPEN SerialUART

#endif /* _VARIANT_SIMIO_DEVICE_M0_ */
