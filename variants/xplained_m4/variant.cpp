...
const PinDescription g_APinDescription[] =
    {
        // 0..13 - Digital pins
        // ----------------------
        // 0/1 - Ethernet RMII receive pins
        {PORTA, 13, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GRX0
        {PORTA, 12, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GRX1
        ...
        // 13 (LED)
        {PORTC, 18, PIO_TIMER_ALT, PIN_ATTR_PWM_F, No_ADC_Channel, TCC0_CH2, NOT_ON_TIMER, EXTERNAL_INT_2}, // LED: TCC0/WO[2]
        ...
        // 27..29 - USB peripheral pins
        // --------------------
        {NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // Reserved; Xplained USB host control is on PC19.
        ...
        // 37..38 Ethernet PHY control
        {PORTD, 12, PIO_INPUT_PULLUP, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7}, // PHY interrupt
        {PORTC, 21, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // PHY reset

        // 39..46 Ethernet RMII/MDIO pins
        {PORTA, 14, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GTXCK
        {PORTA, 15, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GRXER
        {PORTA, 17, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GTXEN
        {PORTA, 18, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GTX0
        {PORTA, 19, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GTX1
        {PORTC, 20, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GRXDV
        {PORTC, 11, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GMDC
        {PORTC, 12, PIO_GMAC, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // GMDIO

        // 47 User button
        {PORTB, 31, PIO_INPUT_PULLUP, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_15}, // BTN0

        // 48..49 Target USB control/status pins
        {PORTC, 0, PIO_INPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0},           // VBUS_DETECT
        {PORTC, 19, PIO_INPUT_PULLUP, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3},   // USB_ID / host enable
};
