...
#define GENERIC_CLOCK_GENERATOR_100M      (2u)
#define GENERIC_CLOCK_GENERATOR_100M_SYNC GCLK_SYNCBUSY_GENCTRL_Msk
#define GENERIC_CLOCK_GENERATOR_12M       (4u)
#define GENERIC_CLOCK_GENERATOR_12M_SYNC  GCLK_SYNCBUSY_GENCTRL_Msk
#define GENERIC_CLOCK_GENERATOR_1M        (5u)
...
//*************** END SAMD51 *************************//
  ...
  OSC32KCTRL_REGS->OSC32KCTRL_XOSC32K =
      ...
      OSC32KCTRL_XOSC32K_EN32K_Msk | OSC32KCTRL_XOSC32K_CGM_XT |
...
#ifndef CRYSTALLESS
  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_XOSC32K] =
      GCLK_GENCTRL_SRC_XOSC32K | GCLK_GENCTRL_GENEN_Msk;
#else
  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_XOSC32K] =
      GCLK_GENCTRL_SRC_OSCULP32K | GCLK_GENCTRL_GENEN_Msk;
#endif
  while (GCLK_REGS->GCLK_SYNCBUSY & GCLK_SYNCBUSY_GENCTRL_Msk);

  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_MAIN] =
      GCLK_GENCTRL_SRC_OSCULP32K | GCLK_GENCTRL_GENEN_Msk;
  while (GCLK_REGS->GCLK_SYNCBUSY & GCLK_SYNCBUSY_GENCTRL_Msk);
  ...
  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_1M] =
      GCLK_GENCTRL_SRC_DFLL | GCLK_GENCTRL_GENEN_Msk | GCLK_GENCTRL_DIV(48);
  while (GCLK_REGS->GCLK_SYNCBUSY & GCLK_SYNCBUSY_GENCTRL_Msk);

  GCLK_REGS->GCLK_PCHCTRL[OSCCTRL_GCLK_ID_FDPLL0] =
      GCLK_PCHCTRL_GEN_GCLK5 | GCLK_PCHCTRL_CHEN_Msk;
  OSCCTRL_REGS->DPLL[0].OSCCTRL_DPLLRATIO =
      OSCCTRL_DPLLRATIO_LDRFRAC(0) | OSCCTRL_DPLLRATIO_LDR((F_CPU - 500000) / 1000000);
  while (OSCCTRL_REGS->DPLL[0].OSCCTRL_DPLLSYNCBUSY & OSCCTRL_DPLLSYNCBUSY_DPLLRATIO_Msk);
  OSCCTRL_REGS->DPLL[0].OSCCTRL_DPLLCTRLB =
      OSCCTRL_DPLLCTRLB_REFCLK_GCLK | OSCCTRL_DPLLCTRLB_LBYPASS_Msk;
  OSCCTRL_REGS->DPLL[0].OSCCTRL_DPLLCTRLA = OSCCTRL_DPLLCTRLA_ENABLE_Msk;
  while ((OSCCTRL_REGS->DPLL[0].OSCCTRL_DPLLSTATUS &
          (OSCCTRL_DPLLSTATUS_CLKRDY_Msk | OSCCTRL_DPLLSTATUS_LOCK_Msk)) !=
         (OSCCTRL_DPLLSTATUS_CLKRDY_Msk | OSCCTRL_DPLLSTATUS_LOCK_Msk));

  GCLK_REGS->GCLK_PCHCTRL[OSCCTRL_GCLK_ID_FDPLL1] =
      GCLK_PCHCTRL_GEN_GCLK5 | GCLK_PCHCTRL_CHEN_Msk;
  OSCCTRL_REGS->DPLL[1].OSCCTRL_DPLLRATIO =
      OSCCTRL_DPLLRATIO_LDRFRAC(0) | OSCCTRL_DPLLRATIO_LDR(99);
  ...
  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_48M] =
      GCLK_GENCTRL_SRC_DFLL | GCLK_GENCTRL_IDC_Msk | GCLK_GENCTRL_GENEN_Msk;
  while (GCLK_REGS->GCLK_SYNCBUSY & GENERIC_CLOCK_GENERATOR_48M_SYNC);

  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_100M] =
      GCLK_GENCTRL_SRC_DPLL1 | GCLK_GENCTRL_IDC_Msk | GCLK_GENCTRL_GENEN_Msk;
  while (GCLK_REGS->GCLK_SYNCBUSY & GENERIC_CLOCK_GENERATOR_100M_SYNC);

  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_12M] =
      GCLK_GENCTRL_SRC_DFLL | GCLK_GENCTRL_IDC_Msk | GCLK_GENCTRL_DIV(4) |
      GCLK_GENCTRL_GENEN_Msk;
  while (GCLK_REGS->GCLK_SYNCBUSY & GENERIC_CLOCK_GENERATOR_12M_SYNC);

  GCLK_REGS->GCLK_GENCTRL[GENERIC_CLOCK_GENERATOR_MAIN] =
      GCLK_GENCTRL_SRC_DPLL0 | GCLK_GENCTRL_IDC_Msk | GCLK_GENCTRL_GENEN_Msk;
  while (GCLK_REGS->GCLK_SYNCBUSY & GCLK_SYNCBUSY_GENCTRL_Msk);

  MCLK_REGS->MCLK_CPUDIV = MCLK_CPUDIV_DIV_DIV1;
  SUPC_REGS->SUPC_VREG &= ~SUPC_VREG_SEL_Msk;
